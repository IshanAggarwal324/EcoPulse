...
Pure-function tests of app.health_contract — no FastAPI app, httpx, or Gemini
calls required, so they run anywhere the stdlib does.
"""
import os
import sys
import unittest
...
class BuildContractTests(unittest.TestCase):
    ...
    def test_overall_is_worst_of_service_and_checks(self):
        ...
        contract = build_contract(
            SERVICE_NAME,
            HEALTHY,
            [{"id": "gemini", "status": "unhealthy", "latencyMs": 0}],
        )
